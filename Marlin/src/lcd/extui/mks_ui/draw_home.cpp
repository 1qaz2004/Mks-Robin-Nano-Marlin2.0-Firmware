...
void lv_draw_home() {
  ...
  lv_big_button_create(scr, "F:/bmp_manual_off.bin", set_menu.shutdown, BTN_X_PIXEL * 2 + INTERVAL_V * 3, BTN_Y_PIXEL + INTERVAL_H + titleHeight, event_handler, ID_H_POWER_OFF);
